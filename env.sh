...
export LD_LIBRARY_PATH=/cvmfs/sft.cern.ch/lcg/releases/LCG_93/Python/2.7.13/x86_64-slc6-gcc7-opt/lib/python2.7:$LD_LIBRARY_PATH
...
export MINICALODIR=$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd -P)
